          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">Enter and manage examination marks for {schoolCode}</p>
              </div>
            </div>
          </div>
        </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="flex items-end gap-2">
              ...
              <Button
                ...
                disabled={saving || submitting || !selectedClass || !selectedSection || !selectedExam || students.length === 0}
                className="flex-1 bg-[#6B9BB8] hover:bg-[#5a8a95] disabled:opacity-50"
              >
                {submitting ? (
                  <>
                    <Loader2 size={18} className="mr-2 animate-spin" />
            ...
            <div className="flex flex-col lg:flex-row items-stretch lg:items-center gap-4">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-3 shrink-0">
                <div className="flex items-center gap-2">
                  ...
                  <label htmlFor="marks-sort-legacy" className="text-xs font-medium text-gray-600 dark:text-gray-400 whitespace-nowrap">
                    Sort
                  </label>
                  <select
                    id="marks-sort-legacy"

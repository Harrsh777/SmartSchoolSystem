  ...
  const fetchCalendar = useCallback(async () => {
    try {
      ...
      const response = await fetch(
        `/api/calendar/academic?school_code=${schoolCode}&academic_year=${selectedYear}`
      );
    ...
    <div className="space-y-6 pb-8 min-h-screen bg-[#ECEDED]">
      ...
      >
        <div>
          ...
          <p className="text-gray-600">View academic calendar and events</p>
        </div>
      ...
      <Card className="p-0 overflow-hidden">
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 text-lg">Log in to view the academic calendar.</p>
          </div>
        ) : (
          <div className="p-6">

...
const FrontOfficeContent = dynamic(
  () =>
    import('@/app/dashboard/[school]/front-office/page').then((mod) => {
      return function FrontOfficeWrapper() {
        const teacherData =
...
export default function TeacherFrontOfficePage() {
  ...
  useEffect(() => {
    const checkPermission = async () => {
      ...
      try {
        ...
        if (menu && menuHasSubmoduleView(menu, ['front_office_dashboard'])) {
      ...
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="text-center">
          ...
          <p className="text-gray-600">
            You don&apos;t have permission to access Front office dashboard.
          </p>
        </div>
      </div>
    );

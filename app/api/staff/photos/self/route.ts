...
/**
 * POST /api/staff/photos/self
 * Allow staff members to upload their own photo
 * No admin permission required - staff can only update their own photo
 */
export async function POST(request: NextRequest) {
  try {
    ...
    const staffId = formData.get('staff_id') as string; // UUID
    ...
    // Verify staff exists and get their data
    ...
    console.error('Error uploading self photo:', error);
    return NextResponse.json(

...
export async function GET(request: NextRequest) {
  try {
    ...
    { name: 'student_manual_attendance', category: 'Student Management', description: 'Manual cumulative attendance (TWD / attended / %) per class-year' },
      ...
      { name: 'transport_fee_payment_entries', category: 'Transport Management', description: 'Transport fee receipts (SEPARATE mode)' },
      { name: 'transport_receipt_counters', category: 'Transport Management', description: 'Sequential transport receipt numbers per school/year' },

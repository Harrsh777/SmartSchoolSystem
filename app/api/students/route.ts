...
export async function GET(request: NextRequest) {
  try {
    ...
    const studentFields =
      'id,admission_no,student_name,first_name,last_name,gender,date_of_birth,class,section,academic_year,status,student_contact,father_name,mother_name,father_contact,mother_contact,parent_name,parent_phone,parent_email,roll_number,email,house,photo_url,created_at,updated_at,transport_route_id,transport_pickup_stop_id,transport_dropoff_stop_id,transport_custom_fare,transport_fee,transport_billing_frequency,transport_type,blood_group,address,city,state,pincode,category,aadhaar_number';
    let query = paginate
      ? supabase
          .from('students')

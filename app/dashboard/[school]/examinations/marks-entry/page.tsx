          ...
          <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
            ...
            <div className="flex items-end gap-2">
              <Button
                ...
                variant="outline"
                size="sm"
                className="px-3 border-[#5A7A95]/30 text-[#5A7A95] hover:bg-[#5A7A95]/10"
              >
                {saving ? (
                  <>
              ...
              <Button
                ...
                size="sm"
                className="px-3 bg-[#5A7A95] hover:bg-[#4a6a85] disabled:opacity-50"
              >
                {submitting ? (
                  <>
                    <Loader2 size={18} className="mr-2 animate-spin" />
          ...
          <Card className="bg-white/85 dark:bg-[#1e293b]/85 backdrop-blur-xl rounded-2xl shadow-lg border border-white/60 dark:border-gray-700/50 p-4">
            <div className="flex flex-col lg:flex-row items-stretch lg:items-center gap-4">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-3 shrink-0">
                ...
                <div className="flex items-center gap-2">
                  <label htmlFor="subject-filter-exam" className="text-xs font-medium text-gray-600 dark:text-gray-400 whitespace-nowrap">
                    Subject
                  </label>
                  <select
                    id="subject-filter-exam"

...
interface ImportResult {
  ...
  passwords?: Array<{ staff_id: string; password: string }>;
}
...
export default function BulkImportPage({
  ...
  const handleImport = async () => {
    ...
    try {
      // Prepare valid staff data (without staff_id - it will be auto-generated)
      const validStaff = validatedRows
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <div>
          <h1 className="text-3xl font-bold text-black mb-2">Bulk Staff Import</h1>
          <p className="text-gray-600">Import multiple staff members from an Excel file</p>
        </div>
      </motion.div>
      ...
      <Card>
        <div className="flex items-center justify-center gap-4 py-4">
          ...
          <div className={`flex items-center gap-2 ${currentStep >= 2 ? 'text-orange-600' : 'text-gray-400'}`}>
            ...
            <span className="font-medium">Upload & Validate</span>
          </div>
          <ArrowRight className="text-gray-400" size={20} />
            ...
            <Card>
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
                  Download the Excel template file, fill it with your staff information, and then upload it in the next step.
                  ...
                  <div className="bg-gray-50 rounded-lg p-6 max-w-2xl mx-auto text-left">
                    ...
                    <ul className="space-y-2 text-gray-700 text-sm">
                      <li className="flex items-start gap-2">
                        ...
                        <span>Staff ID will be auto-generated (STF001, STF002, etc.) - do not include it in your file</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle size={18} className="text-green-600 mt-0.5 flex-shrink-0" />
                        <span>Passwords will be auto-generated for each staff member</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle size={18} className="text-green-600 mt-0.5 flex-shrink-0" />
            ...
            <Card>
              <div className="py-8">
                <div className="text-center mb-8">
                  ...
                  <h2 className="text-2xl font-bold text-black mb-2">Step 2: Upload & Validate</h2>
                  <p className="text-gray-600">Upload your filled Excel file for validation</p>
                </div>
                ...
                <div className="max-w-2xl mx-auto">
                  ...
                  {uploadedFile && (
                    <div className="mt-6 text-center">
                      ...
                      <div className="mt-4 animate-spin rounded-full h-8 w-8 border-b-2 border-orange-600 mx-auto"></div>
                    </div>
                  )}
                </div>
            ...
            <Card>
              <div className="py-8">
                <div className="text-center mb-8">
                  ...
                  <h2 className="text-2xl font-bold text-black mb-2">Step 3: Review & Import</h2>
                  <p className="text-gray-600">Review validation results and import staff</p>
                </div>
            ...
            <Card>
              <div className="py-8">
                <div className="text-center mb-8">
                  ...
                  <p className="text-gray-600">Staff import has been processed</p>
                </div>
                  ...
                  <div className="mb-8 max-w-3xl mx-auto">
                    ...
                    <div className="bg-gray-50 rounded-lg p-4 max-h-64 overflow-y-auto">
                      <p className="text-sm text-gray-600 mb-2">
                        Passwords have been auto-generated for all imported staff members.

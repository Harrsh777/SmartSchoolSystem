    ...
    <div className="space-y-6 pb-8 min-h-screen bg-[#ECEDED]">
      ...
      >
        <div>
          ...
          <p className="text-gray-600">Manage and approve staff leave requests</p>
        </div>
                ...
                {filteredLeaves.map((leave, index) => (
                  ...
                  >
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-600 font-mono">{leave.staff_id}</p>
                        </div>
                      </div>
                    </td>
                    <td className="px-4 py-3">
                    ...
                    <td className="px-4 py-3 text-sm text-gray-600">
                      ...
                      <span className="text-gray-500 ml-2">({leave.total_days} {leave.total_days === 1 ? 'Day' : 'Days'})</span>
                    </td>
                    <td className="px-4 py-3 text-sm text-gray-600">
                      {leave.comment || '-'}
                    </td>

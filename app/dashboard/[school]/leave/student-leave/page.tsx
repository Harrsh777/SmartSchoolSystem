...
export default function StudentLeavePage({
    ...
    try {
      ...
      if (response.ok && result.data) {
        ...
        if (allStudentResponse.ok && allStudentResult.data) {
          ...
          setStats({
            pending: allStudent.filter((l: StudentLeave) => l.status === 'pending').length,
            approved: allStudent.filter((l: StudentLeave) => l.status === 'approved').length,
            rejected: allStudent.filter((l: StudentLeave) => l.status === 'rejected').length,
          });
        }
      }
    } catch (err) {
  ...
  const handleRefresh = () => {
    setRefreshing(true);
    fetchStudentLeaves().finally(() => setRefreshing(false));
  };
      ...
      >
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-1">Student Leave</h1>
              <p className="text-gray-600 text-sm">Manage and approve student leave requests</p>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        >
          <Card className="p-5 bg-gradient-to-br from-amber-50 to-orange-50 border-2 border-amber-200 shadow-xl hover:shadow-2xl transition-shadow">
            ...
            <h3 className="font-bold text-sm text-gray-900">Pending</h3>
        ...
        >
          <Card className="p-5 bg-gradient-to-br from-emerald-50 to-green-50 border-2 border-emerald-200 shadow-xl hover:shadow-2xl transition-shadow">
            ...
            <h3 className="font-bold text-sm text-gray-900">Approved</h3>
        ...
        >
          <Card className="p-5 bg-gradient-to-br from-red-50 to-rose-50 border-2 border-red-200 shadow-xl hover:shadow-2xl transition-shadow">
            ...
            <h3 className="font-bold text-sm text-gray-900">Rejected</h3>
          ...
          <div className="mb-6">
            <div className="relative">
              ...
              <Input
                ...
                placeholder="Search by student name, admission no, or leave title..."

-- Final Safe Leave Management System Migration Script
-- This script ONLY adds missing columns and creates tables that don't exist
...
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'leave_types') THEN
...
-- ============================================================================
-- STEP 2: Handle staff_leave_requests table - ONLY ADD MISSING COLUMNS
-- ============================================================================
-- IMPORTANT: This section ONLY adds missing columns, it does NOT recreate the table
DO $$ 
BEGIN
  -- Only proceed if table exists
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'staff_leave_requests') THEN
    -- Add reason column if it doesn't exist
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema = 'public' AND table_name = 'staff_leave_requests' AND column_name = 'reason') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema = 'public' AND table_name = 'staff_leave_requests' AND column_name = 'comment') THEN
...
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'student_leave_requests') THEN

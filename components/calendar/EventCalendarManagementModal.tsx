...
import { X, Calendar, CalendarDays, ExternalLink } from 'lucide-react';
import { useRouter } from 'next/navigation';

interface EventCalendarManagementModalProps {
  isOpen: boolean;
  onClose: () => void;
  schoolCode: string;
}
          ...
          >
            <div className="p-6">
              ...
              <div className="flex items-center justify-between mb-8">
                <h2 className="text-2xl font-bold text-white uppercase tracking-wide bg-gradient-to-r from-pink-400 to-rose-400 bg-clip-text text-transparent">Event/Calendar</h2>
                <button
                  onClick={onClose}

  ...
  return (
    <div className="p-8">
      <div className="text-center mb-8">
        <div className="inline-flex p-3 rounded-2xl bg-gradient-to-br from-blue-500 to-cyan-400 text-white mb-4">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <Input
            ...
            required
            className={fieldErrors.admission_no ? 'border-red-500' : ''}
          />
          {fieldErrors.admission_no && (
            <p className="text-red-600 text-sm mt-1">{fieldErrors.admission_no}</p>
          )}
        </div>

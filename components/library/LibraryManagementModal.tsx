...
const menuItems = [
  { id: 'basics', label: 'Library Basics', icon: Settings, path: '/library/basics' },
  { id: 'catalogue', label: 'Catalogue', icon: Book, path: '/library/catalogue' },
  { id: 'transactions', label: 'Transactions', icon: FileText, path: '/library/transactions' },
  { id: 'dashboard', label: 'Library Dashboard', icon: BarChart3, path: '/library/dashboard' },
];

export default function LibraryManagementModal({ isOpen, onClose, schoolCode }: LibraryManagementModalProps) {
              ...
              <div className="flex items-center justify-between mb-8">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white/60 text-xs">Manage library system</p>
                  </div>
                </div>
                <button
                  onClick={onClose}

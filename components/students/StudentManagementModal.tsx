...
import { X, Users, UserPlus, Upload, Calendar, UsersRound, ExternalLink } from 'lucide-react';
...
export default function StudentManagementModal({ isOpen, onClose, schoolCode }: StudentManagementModalProps) {
          ...
          >
            <div className="p-6">
              ...
              <div className="flex items-center justify-between mb-8">
                <h2 className="text-2xl font-bold text-white uppercase tracking-wide bg-gradient-to-r from-pink-400 to-rose-400 bg-clip-text text-transparent">Student Management</h2>
                <button
                  onClick={onClose}

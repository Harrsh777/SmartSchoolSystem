...
export default function TimetableManagementModal({ isOpen, onClose, schoolCode }: TimetableManagementModalProps) {
          ...
          >
            <div className="p-6">
              ...
              <div className="flex items-center justify-between mb-8">
                <h2 className="text-2xl font-bold text-white uppercase tracking-wide bg-gradient-to-r from-pink-400 to-rose-400 bg-clip-text text-transparent">Timetable Management</h2>
                <button
                  onClick={onClose}
                ...
                {menuItems.map((item) => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-full flex items-center justify-between p-4 text-left rounded-xl transition-all duration-200 group border ${
                        item.highlight 
                          ? 'bg-pink-500/20 border-pink-400/50 hover:bg-pink-500/30 hover:shadow-lg hover:shadow-pink-500/20' 
                          : 'bg-white/5 border-white/10 hover:bg-white/10 hover:border-pink-500/50 hover:shadow-lg hover:shadow-pink-500/20'
                      }`}
                    >
